...
import { Briefcase, ExternalLink, Building, Code2 } from "lucide-react"
...
const experiences = [
  {
    ...
    period: "2024 - Present",
    description:
      "Working with clients worldwide to deliver high-quality web applications and solutions. Specializing in React, Next.js, Node.js, and modern web technologies.",
    skills: ["Fullstack"],
    link: {
